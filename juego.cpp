...
void modo1jugador(int &puntajeMax, string &NombrePuntajeMaximo)
{
...
/////////////////////////////////////Escalera A///////////////////////////////////////
        ...
        if(valorEscalera1 == true)
        {
            ...
            puntajeJuego = 100;
            if(puntajeJuego > puntajeMax)
            {
                NombrePuntajeMaximo = nombre;
                puntajeMax = puntajeJuego;
            }
...
void modo2jugadores(int &puntajeMax, string &NombrePuntajeMaximo)
{
//variables de tirada//
...
/////////////////////////////////////Escalera A JUGADOR 2///////////////////////////////////////
        ...
        if(valorEscaleraA == true)
        {
            ...
            puntajeJuego2 = 100;
            if(puntajeJuego2 > puntajeMax)
            {
                NombrePuntajeMaximo = nombre2;
                puntajeMax = puntajeJuego2;
            }
...
//ESTADISTICAS Y GANADOR DEL JUEGO//
    ...
    while(puntajeJuego >= 100 && puntajeJuego2 >= 100)
    {
        ...
        else if(puntajeJuego == puntajeJuego2)
        {
            ...
            else if(puntajeJuego2 > puntajeMax)
            {
                NombrePuntajeMaximo = nombre2;
                puntajeMax = puntajeJuego2;
            }
